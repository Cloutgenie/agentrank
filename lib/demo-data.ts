...
export const demoCompetitorComparison = [
  { name: "Agent Rank Radar (you)", score: 40, isYou: true },
...
export const demoPrompts = [
  ...
  { id: "p3", text: "Agent Rank Radar vs Profound", category: "comparison", mentionType: "mentioned" as const, position: 2, engine: "claude" },
...
export const demoRecommendations = [
  {
    id: "r1",
    title: 'Publish "Agent Rank Radar vs Profound" comparison page',
