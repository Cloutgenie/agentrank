        ...
        {results.length === 0 ? (
          <Card>
            <CardContent className="p-8 text-center text-sm text-muted-foreground">
              Your buyer-intent prompts were generated during onboarding — results for each one will appear here after
          ...
          <>
            <p className="text-sm text-muted-foreground">
              {promptCount} buyer-intent prompts generated for your category, {results.length} results across all tracked
              engines.
            </p>
