...
export const metadata: Metadata = {
  ...
  description:
    "Which Shopify apps get recommended most often by ChatGPT, Claude, Gemini, and Perplexity? An illustrative AI visibility leaderboard for the Shopify app ecosystem, tracked by AgentRank.",
};
...
const FAQ = [
  {
    ...
    a: "This page shows an illustrative example of the leaderboard format AgentRank produces — the app names and scores above are for demonstration. Track your own Shopify app's real AI Visibility Score by creating a project.",
  },
  {
    q: "How would AgentRank track a real Shopify app category?",
  ...
  },
  {
    ...
    a: "Yes. Add any competitor app names when you set up a project, and AgentRank tracks their mentions across the exact same prompts as yours, so the comparison is apples-to-apples.",
  },
  {
      ...
      <section className="relative overflow-hidden border-b border-border/60 bg-grid">
        ...
        <div className="container relative flex flex-col items-center py-24 text-center md:py-32">
          ...
          <p className="mt-6 max-w-xl text-balance text-lg text-muted-foreground">
            ...
            how AgentRank scores a Shopify app category for AI visibility — and how your app would stack up.
          </p>
      ...
      <section className="border-b border-border/60 py-20">
        <div className="container">
          ...
          <p className="mx-auto mt-4 max-w-4xl text-xs text-muted-foreground">
            App names and scores are illustrative examples of AgentRank's output format, not real measurements of
      ...
      <section className="border-b border-border/60 py-24">
        <div className="container">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mt-4 text-muted-foreground">
              AgentRank can generate this same view for any Shopify app category — or any SaaS category at all.
